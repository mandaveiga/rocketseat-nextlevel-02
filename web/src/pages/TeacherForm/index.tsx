    ...
    return (
        <div id="page-teacher-form" className="container">
            <PageHeader title="Que incrível que você quer dar aulas."
                description="O primeiro passo é preencher ess formulario de inscrição"
            />
            <main>
                <form onSubmit={handleCreateclass}>
                    ...
                    <footer>
                        <p>
                            <img src={warningIcon} alt="aciso importante" />
                        Importante!<br />
                        Preencha todos os dados
                    </p>
                        <button type="submit">Salvar cadasatro</button>
